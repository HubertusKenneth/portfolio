...
const Hero = () => {
  ...
  const downloadCV = () => {
    ...
    link.href = '/portfolio/Hubertus Kenneth Alfragisa - CV.pdf'; 
  ...
  const downloadPortfolio = () => {
    const link = document.createElement('a');
    link.href = '/portfolio/Hubertus Kenneth Alfragisa - Portfolio.pdf'; 
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center relative overflow-hidden pt-16 pb-20">
      ...
      <motion.div 
        ...
        animate={{ scale: [1.2, 1, 1.2], opacity: [0.6, 0.3, 0.6], x: [0, -40, 0], y: [0, 20, 0] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 2 }}
      />
      <motion.div 
        className="hero-floating-element"
        animate={{ scale: [1, 1.5, 1], opacity: [0.2, 0.5, 0.2], rotate: [0, 180, 360] }}
      ...
      <div className="relative z-10 w-full mx-auto px-4 sm:px-6 flex-1 flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full max-w-none">
          
          {/* Text Section */}
          <div className="flex flex-col text-center lg:text-left order-2 lg:order-1 px-0 lg:pl-56">
            <motion.div
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.3 }}>
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 mb-4">Computer Science Student</p>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.5 }}>
              <p className="text-sm sm:text-base lg:text-lg text-gray-400 mb-6 lg:mb-8 max-w-2xl mx-auto lg:mx-0 px-2 lg:px-0">
                Passionate about technology and creating meaningful digital experiences. Currently pursuing my Bachelor's in Computer Science at BINUS University, 
                with a strong focus on continuously developing and sharpening my skills.
              </p>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.7 }}>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 lg:mb-8 justify-center lg:justify-start px-4 lg:px-0">
                <button onClick={downloadCV}
                  className="group flex items-center gap-2 sm:gap-3 relative text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-full font-semibold justify-center text-sm sm:text-base
                    transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25 bg-gray-900/70 backdrop-blur-sm outline-animated">
                ...
                <button onClick={downloadPortfolio}
                  className="group flex items-center gap-2 sm:gap-3 relative text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-full font-semibold justify-center text-sm sm:text-base
                    transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25 bg-gray-900/70 backdrop-blur-sm outline-animated">
                  <Download size={16} className="sm:w-[18px] sm:h-[18px] group-hover:animate-bounce" />
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.9 }}>
              <div className="flex space-x-4 sm:space-x-6 justify-center lg:justify-start">
                <a href="mailto:hubertus.alfragisa@binus.ac.id" className="p-2.5 sm:p-3 bg-gray-800/50 rounded-full hover:bg-blue-600/20 hover:scale-110 transition-all duration-300 group">
                  <Mail size={20} className="sm:w-6 sm:h-6 text-gray-400 group-hover:text-blue-400" />
                </a>
                <a href="https://www.linkedin.com/in/hubertuskenneth/" className="p-2.5 sm:p-3 bg-gray-800/50 rounded-full hover:bg-blue-600/20 hover:scale-110 transition-all duration-300 group">
                  <Linkedin size={20} className="sm:w-6 sm:h-6 text-gray-400 group-hover:text-blue-400" />
                </a>
                <a href="https://github.com/HubertusKenneth" className="p-2.5 sm:p-3 bg-gray-800/50 rounded-full hover:bg-purple-600/20 hover:scale-110 transition-all duration-300 group">
          ...
          {/* Profile Image */}
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ type: "spring", stiffness: 80, damping: 15, duration: 1.2 }} className="order-1 lg:order-2 lg:pr-56">
